...
```bash
~/.agents/skills/mem-ai-skill/scripts/memctl search "我想找之前保存的 FastClaw 笔记，重点看用途、适用场景和风险"
~/.agents/skills/mem-ai-skill/scripts/memctl search "我想找之前保存的 FastClaw 笔记 用途 适用场景 风险 OpenClaw 托管"
```
